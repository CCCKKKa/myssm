...
//导出表的列名
    ...
    public InputStream export() throws Exception{
        ...
        HSSFRow rowRowName=sheet.createRow(0);//在索引2的位置创建行，对顶端开始的第二行
        //将列头设置到sheet的单元格中
        for (int n=0;n<columnNum;n++){
            HSSFCell cellRowName=rowRowName.createCell(n);//创建列头个数对应的单元格
...
//				        FileOutputStream out=new FileOutputStream("C:\\test.xls");
    ...
    public static void main(String[] args) throws Exception {
        ...
        obj1[0]="1";obj1[1]="ok";obj1[2]="hello";obj1[3]="11";
        dataList.add(obj1);
